...
-- General keymaps
keymap.set("n", "<leader>wq", ":wq<CR>", { desc = "Save and quit from file"}) -- save and quit
keymap.set("n", "<leader>qq", ":q!<CR>", { desc = "Quit from file without saving"}) -- quit without saving
...
keymap.set("n", "<leader>s+", "<C-w>>5", { desc = "Make split window width bigger"}) -- make split windows width bigger 
keymap.set("n", "<leader>s-", "<C-w><5", {desc = "Make split windows windows smaller"}) -- make split windows width smaller
...
keymap.set("n", "<leader>tl", ":tabn<CR>", {desc = "Go to next tab"}) -- next tab
keymap.set("n", "<leader>th", ":tabp<CR>", {desc = "Go to previous tab"}) -- previous tab
...
-- Vim-maximizer
keymap.set("n", "<leader>sm", ":MaximizerToggle<CR>", {desc = "Maximize tab"}) -- toggle maximize tab

-- Nvim-tree
keymap.set("n", "<leader>ee", ":NvimTreeToggle<CR>", { desc = "Open file explorer"}) -- toggle file explorer
keymap.set("n", "<leader>er", ":NvimTreeFocus<CR>") -- toggle focus to file explorer
keymap.set("n", "<leader>ef", ":NvimTreeFindFile<CR>", {desc = "Open file explorer from current file"}) -- find file in file explorer

-- Telescope
keymap.set('n', '<leader>ff', require('telescope.builtin').find_files, {desc = "Open find files"})
keymap.set('n', '<leader>fg', require('telescope.builtin').live_grep, {desc = "Open find live_grep"})
keymap.set('n', '<leader>fb', require('telescope.builtin').buffers, {desc = "Open find in current buffer"})
keymap.set('n', '<leader>fh', require('telescope.builtin').help_tags, {})
keymap.set('n', '<leader>fs', require('telescope.builtin').current_buffer_fuzzy_find, {desc = "Oepn find string"})
...
keymap.set('n', '<leader>gd', '<cmd>lua vim.lsp.buf.definition()<CR>', { desc = "Go to document"})
...
keymap.set('n', '<leader>gn', '<cmd>lua vim.diagnostic.open_float()<CR>')
keymap.set('n', '<leader>gh', '<cmd>lua vim.diagnostic.goto_prev()<CR>')
keymap.set('n', '<leader>gl', '<cmd>lua vim.diagnostic.goto_next()<CR>')
...
-- Debugging
keymap.set("n", "<leader>bb", "<cmd>lua require'dap'.toggle_breakpoint()<cr>", {desc = "Mark break point"})
keymap.set("n", "<leader>bc", "<cmd>lua require'dap'.set_breakpoint(vim.fn.input('Breakpoint condition: '))<cr>")
keymap.set("n", "<leader>bl", "<cmd>lua require'dap'.set_breakpoint(nil, nil, vim.fn.input('Log point message: '))<cr>")
keymap.set("n", '<leader>br', "<cmd>lua require'dap'.clear_breakpoints()<cr>")
keymap.set("n", '<leader>ba', '<cmd>Telescope dap list_breakpoints<cr>')
keymap.set("n", "<leader>dc", "<cmd>lua require'dap'.continue()<cr>", {desc = "Open debug"})
